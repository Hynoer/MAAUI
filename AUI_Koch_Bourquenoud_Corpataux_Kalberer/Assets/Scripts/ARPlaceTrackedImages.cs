// from https://www.andreasjakl.com/2d-image-tracking-with-ar-foundation-part-4/
// from https://github.com/andijakl/AR-Foundation-Demo/blob/main/Assets/Scripts/ARPlaceTrackedImages.cs
...
public class ARPlaceTrackedImages : MonoBehaviour
{
    ...
    private void OnTrackedImagesChanged(ARTrackedImagesChangedEventArgs eventArgs)
    {
        ...
        foreach (var trackedImage in eventArgs.added)
        {
            ...
            foreach (var curPrefab in ArPrefabs)
            {
                    ...
                    && !_instantiatedPrefabs.ContainsKey(imageName))
                {
                    ...
                    Debug.Log($"{Time.time} -> Instantiated prefab for tracked image (name: {imageName}).\n" +
                               $"newPrefab.transform.parent.name: {newPrefab.transform.parent.name}.\n" +
                               $"guid: {trackedImage.referenceImage.guid}");
        ...
        foreach (var trackedImage in eventArgs.removed)
        {
            ...
            Debug.Log($"REMOVED (guid: {trackedImage.referenceImage.guid}).");
